...
All accounts in SparkPost start with an IP Pool named **default**. This IP Pool will be where your dedicated IP is assigned if you do not specify another pool on creation. At this time, the **default** pool is not much more than a placeholder to help you learn about how IP Pools work and does not have any of the properties that a regular IP Pool does. In order to assign or use an overflow pool, you'll need to create a new IP pool that is different than **default** and assign your dedicated IP to that pool. Using something like **password reset**, **transactional**, or **marketing** is a good place to start and will help you segment and track your sending more easily as you grow.
