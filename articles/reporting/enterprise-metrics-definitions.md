...
|--------------------------|----------------------------------------|-------------|
| Targeted                 | `count_targeted`                       | Number of emails successfully received by SparkPost. |
| Injected                 | `count_injected`                       | Number of emails successfully received and generated by SparkPost. |
...
| Rejected                 | `count_rejected`                       | Number of emails that were not generated. Includes Policy Rejections, Generation Rejections, Generation Faliures. Rejections are also counted as Admin Bounces. |
| Policy Rejections        | `count_policy_rejection`               | Number of emails that were not generated due to policy reasons. |
...
| Bounces                  | `count_bounce`                         | Number of bounced emails, except Admin Bounces. Includes all In-Band and Out-of-Band Bounces. |
...
| Hard Bounces             | `count_hard_bounce`                    | Number of emails that bounced due to permanent delivery isses. |
...
| Unique Clicks            | `count_unique_clicked_approx`          | Number of emails that had at least one link clicked. Approximated with a 5% error threshold. |
...
| Unique Confirmed Opens   | `count_unique_confirmed_opened_approx` | Number of emails that were displayed or had at a link clicked. Approximated with a 5% error threshold. |
...
| Unique Renders           | `count_unique_rendered_approx`         | Number of emails that were displayed at least once. Applies only to HTML emails. Approximated with a 5% error threshold. |
...
| Unique Initial Rendered  | `count_unique_initial_rendered_approx` | Number of emails that were displayed at least once, as recorded by top open pixels. Applies only to HTML emails. Approximated with a 5% error threshold. |
