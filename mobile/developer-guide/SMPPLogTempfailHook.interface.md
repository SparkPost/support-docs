...
### <a name="idp594000"></a> 11.2.1. Function Interface for Lua

`function mod:smpp_log_tempfail(conn, msg, error)`
### <a name="idp595792"></a> 11.2.2. Function Interface for C
...
### <a name="idp598640"></a> 11.2.3. Parameters
...
### <a name="idp603552"></a> 11.2.4. Return Values
