...
### <a name="idp529904"></a> 8.2.1. Function Interface for Lua

`function mod:smpp_log_permfail(conn, msg, error)`
### <a name="idp531696"></a> 8.2.2. Function Interface for C
...
### <a name="idp508896"></a> 8.2.3. Parameters
...
### <a name="idp513824"></a> 8.2.4. Return Values
