---
title: "1.2. Developing Applications for the SMPP ESME"
...
*   [Chapter 13, *SMPP MT Conversion Hook*](SMPPMTConversionHook "Chapter 13. SMPP MT Conversion Hook") 

*   [Chapter 12, *SMPP MO Conversion Hook*](SMPPMOConversionHook "Chapter 12. SMPP MO Conversion Hook") 

*   [Chapter 2, *SMPP Delivery Receipt Evaluation Hook*](SMPPDeliveryReceiptEvaluationHook "Chapter 2. SMPP Delivery Receipt Evaluation Hook") 
...
*   [Chapter 17, *SMPP Submit Response Hook*](SMPPSubmitResponseHook "Chapter 17. SMPP Submit Response Hook") 

*   [Chapter 16, *SMPP Received Message Validation Hook*](SMPPReceivedMessageValidationHook "Chapter 16. SMPP Received Message Validation Hook") 

### <a name="idp196528"></a> 1.2.1. SMPP Logging Hook Points

Mobile Momentum utilizes the extensible logging infrastructure provided by core Momentum ([https://support.messagesystems.com/docs/web-ref/extending.logging.php](https://support.messagesystems.com/docs/web-ref/extending.logging)) to provide customer flexibility to implement their own logging system for mobile messages. As with other Momentum modules such as SMTP, MM7, the following logger hooks are available for logging SMPP messages at different phases:

*   [Chapter 7, *SMPP Log Delivery Hook*](SMPPLogDeliveryHook "Chapter 7. SMPP Log Delivery Hook") 

*   [Chapter 9, *SMPP Log Reception Hook*](SMPPLogReceptionHook "Chapter 9. SMPP Log Reception Hook") 

*   [Chapter 10, *SMPP Logger Status Hook*](SMPPLogStatusHook "Chapter 10. SMPP Logger Status Hook") 

*   [Chapter 11, *SMPP Log Tempfail Hook*](SMPPLogTempfailHook "Chapter 11. SMPP Log Tempfail Hook") 

*   [Chapter 8, *SMPP Log Permfail Hook*](SMPPLogPermfailHook "Chapter 8. SMPP Log Permfail Hook") 

*   [Chapter 6, *SMPP Log Conversion Hook*](SMPPLogConversionHook "Chapter 6. SMPP Log Conversion Hook") 

*   [Chapter 3, *SMPP Log Inband Bounce Hook*](SMPPLogInbandBounceHook "Chapter 3. SMPP Log Inband Bounce Hook") 

*   [Chapter 4, *SMPP Log Outband Bounce Hook*](SMPPLogOutbandBounceHook "Chapter 4. SMPP Log Outband Bounce Hook") 

*   [Chapter 5, *SMPP Log Transient Bounce Hook*](SMPPLogTransientBounceHook "Chapter 5. SMPP Log Transient Bounce Hook") 
...
### <a name="DC.SMPPrelatedec_messagecontextvariablesacc"></a> 1.2.2. SMPP-related ec_message Context Variables Accessible Through SMPP Hooks
