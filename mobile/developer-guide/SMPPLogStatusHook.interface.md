...
### <a name="idp563776"></a> 10.2.1. Function Interface for Lua

`function mod:smpp_log_status(conn, msg, error)`
### <a name="idp565568"></a> 10.2.2. Function Interface for C
...
### <a name="idp567472"></a> 10.2.3. Parameters
...
### <a name="idp580592"></a> 10.2.4. Return Values
