...
### <a name="idp1319856"></a> A.2.1. Content Sections
...
The SOAP envelope in the MCMT MM7 section is optional. **Momentum does not yet support the SOAP envelope shown in [Example A.2, “With a SOAP Envelope”](mobility.mcmt.injection#example.soap.envelope "Example A.2. With a SOAP Envelope").**                                                                                                                                                                           The following example shows a MCMT MM7 part without a SOAP envelope:
