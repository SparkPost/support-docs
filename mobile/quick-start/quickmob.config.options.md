---
title: "Chapter 4. Configuration Options in the Global, Domain and Binding Scopes"
...
[navigation post_type="momentum_article" path="/momentum/mobile/quick-start/quickmob.config.options"]
...
## <a name="quickmob.smpp.specific"></a> 4.1. SMPP-specific Configuration

### <a name="quickmob.config.domain"></a> 4.1.1. Domain Configuration
...
### <a name="quickmob.ram.ds"></a> 4.1.2. Transforming Email to SMS
...
### <a name="quickmob.persistent.connections"></a> 4.1.3. Persistent Connections
