...
interface AnalystIndexListPageContentProps {
  navigationData: NavigationItemProps | undefined;
}

const AnalystIndexListPageContent = (props: AnalystIndexListPageContentProps) => {
...
export default AnalystIndexListPageContent;
