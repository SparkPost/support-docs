---
title: "13.2. Removing a Platform Node"
...
### <a name="node_remove.removing_node"></a> 13.2.1. Remove the Node
...
### <a name="node_remove.modify_config"></a> 13.2.2. Modify the Configuration on the Remaining Platform Nodes
...
### <a name="node_remove.production.json"></a> 13.2.3. Remove the Node from the `production.json` Files
...
### <a name="node_remove.decommission_from_cassandra"></a> 13.2.4. Decommission the Node from the Cassandra Cluster
...
### <a name="node_remove.move_spool_file"></a> 13.2.5. Move the Spool Files
...
### <a name="node_remove.final_steps"></a> 13.2.6. Final Steps
