...
### <a name="policy.scriptlets.helperfunctions"></a> 62.2.1. Helper Functions
...
### <a name="implementing.policy.scriptlets.callouts"></a> 62.2.2. Callouts
...
### <a name="default.policy.scriptlets"></a> 62.2.3. Default Policy Scripts

Default Lua policy scripts are included with Momentum for receiving. These scriptlets are found in the `/opt/msys/ecelerity/libexec/scriptlets/msys/default_policy.lua` file. These files are discussed in detail in the [Default Policy User Guide](/3/3-policy/index).
...
### <a name="policy.best.practices"></a> 62.2.4. Creating Policy Scripts
...
### <a name="policy.scriptlets.examples"></a> 62.2.5. Examples
