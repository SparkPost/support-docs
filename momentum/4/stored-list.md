---
title: "Chapter 50. Creating Stored Recipient Lists"
...
Congratulations! You have created your first stored recipient list using Momentum's Recipient Lists API. To learn more about managing recipient lists, see the Recipient Lists API documentation available at [Momentum 4 REST API](/web-rest/v1_index.html/v-1-index-html).

## <a name="manage_list_ui"></a> 50.1. Managing Recipient Lists using the UI
