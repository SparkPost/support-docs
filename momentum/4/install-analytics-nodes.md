---
title: "9.3. Configure the Analytics Nodes"
...
### <a name="install.first_analytics_nodes"></a> 9.3.1. Configure the First Analytics Node
...
### <a name="install.remaining_analytics_nodes"></a> 9.3.2. Configure the Remaining Analytics Nodes by Copying Files
...
### <a name="install.configure_vertica"></a> 9.3.3. Configure Vertica
