---
title: "71.7. as_logger – Audit Series Logger"
...
### <a name="modules.auth_ds.configuration"></a> 71.7.1. Configuration
...
### <a name="module.as_logger.cidr_maintain.conf"></a> 71.7.2. `cidr_maintain.conf` File
