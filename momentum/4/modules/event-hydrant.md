---
title: "71.33. event_hydrant – Message Tracking"
...
*   [Metrics API](/web-rest/v1_index.html/v-1-index-html)

*   [Webhooks API](/web-rest/v1_index.html/v-1-index-html) or Webhooks page of the UI (See [Chapter 60, *Managing Your Webhooks in the UI*](web-ui.webhooks "Chapter 60. Managing Your Webhooks in the UI") .)
...
### <a name="modules.event_hydrant.configuration"></a> 71.33.1. Configuration
