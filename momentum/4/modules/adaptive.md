---
title: "71.3. adaptive – Adaptive Delivery"
...
### <a name="modules.adaptive.configuration"></a> 71.3.1. Configuration
...
### <a name="modules.adaptive.options.adaptive.scope"></a> 71.3.2. Options Valid in the `adaptive_scope`
...
Depending on the number of bindings in your configuration and the number of domains being delivered to, the default value for this option may be too small. For a detailed discussion of this topic see [Using the System Console](/3/3-ad/ad.troubleshooting.console/ad-troubleshooting-console).
...
### <a name="modules.adaptive.options"></a> 71.3.3. Options That Affect Specific Domains
...
The AD rules govern the behavior of the following options and will dynamically tune them for the receivers specified. (For more information see [Adaptive Delivery User Guide](/3/3-ad/index).)
...
### <a name="modules.adaptive.options.adaptive_scope"></a> 71.3.4. `adaptive_scope` Option
...
### <a name="modules.adaptive.adaptive_sweep_rule_scope"></a> 71.3.5. `adaptive_sweep_rule` Scope
...
Default value is `("suspend" "4 hours")`. For a complete list of valid values see [Rule Actions](/3/3-ad/ad.adaptive.rules.actions/ad-adaptive-rules-actions). The throttle, blackhole, and suspend actions will generate an email to the address associated with the `adaptive_alert_email_destination` option.
...
Default value is `("throttle" "down")`. For a complete list of valid values see [Rule Actions](/3/3-ad/ad.adaptive.rules.actions/ad-adaptive-rules-actions). The throttle, blackhole, and suspend actions will generate an email to the address associated with the `adaptive_alert_email_destination` option.
...
### <a name="modules.adaptive.console"></a> 71.3.6. Console Commands
...
### <a name="modules.adaptive.sample.email"></a> 71.3.7. Summary Email
...
### <a name="modules.adaptive.options.logging"></a> 71.3.8. Logging
