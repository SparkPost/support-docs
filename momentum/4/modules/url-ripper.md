---
title: "71.73. url_ripper – URL Extraction"
...
### <a name="idp23203536"></a> 71.73.1. Configuration
...
This module no longer supports the `checklist_suppress_hostnames` and `checklist_suppress_ips` options, which were dependent upon the deprecated `checklist` module. You can replace this functionality with Lua datasource functions. For more information, see [Section 71.29, “ds_core - Datasource Query Core”](modules.ds_core "71.29. ds_core - Datasource Query Core") and [msys.dp_config.whitelist](/3/3-policy/policy.default.configuration#policy.default.configuration.msys.dp_config.whitelist/policy-default-configuration#policy.default.configuration.msys.dp_config.whitelist).
...
### <a name="idp23233664"></a> 71.73.2. Operational Example
