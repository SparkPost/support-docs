---
title: "71.44. Live Bounce Updates – Live Bounce Updates Service"
...
### <a name="modules.live.bounce.updates.configuration"></a> 71.44.1. Configuration

If you do not wish to leave port 443 open, you can process bounce updates manually. For instructions, see [Automated Updates for the Adaptive Rules](/3/3-ad/ad.adaptive.update/ad-adaptive-update).
...
This setting enables automatic updating of the adaptive rules using port `443`. To disable adaptive updates, set this option to `disabled`. You can also choose to update adaptive rules using a proxy server or manually. For instructions, see [Automated Updates for the Adaptive Rules](/3/3-ad/ad.adaptive.update/ad-adaptive-update).
