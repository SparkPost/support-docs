---
title: "Chapter 59. Using Webhooks for Event Data"
...
5.  Confirm receipt of event data.
    ...
    The response shown is an example. For the latest mapping of the fields that constitute a payload for a given event type, see the Webhooks API documentation at [Momentum 4 REST API](/web-rest/v1_index.html/v-1-index-html).
