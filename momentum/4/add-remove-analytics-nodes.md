---
title: "Chapter 14. Adding and Removing Analytics Nodes"
...
### <a name="node_add_analytics.prepare_new_node"></a> 14.1.1. Prepare the New Node
...
### <a name="node_add_analytics.vertica"></a> 14.1.2. Add the Node to the Vertica Cluster and Database
...
### <a name="node_add_analytics.config_files"></a> 14.1.3. Update and Distribute Configuration Files
...
### <a name="node_add_analytics.platform_mta_nodes"></a> 14.1.4. Update all Platform/MTA Nodes (not Manager/Log Aggregator)
