...
[navigation path="/4/cluster.cidr_server"]
...
## <a name="cluster.cidr_cli"></a> 39.1. `cidr_cli` Utility
...
### <a name="cluster.cidr_cli.grammar"></a> 39.1.1. `cidr_cli` Grammar
...
### <a name="cluster.cidr_cli.using"></a> 39.1.2. Using `cidr_cli`
