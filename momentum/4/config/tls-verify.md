...
For custom behavior create a C module that uses the [outbound_smtp_tls_verify_callback](/3/3-api/hooks.core.outbound_smtp_tls_verify_callback/hooks-core-outbound-smtp-tls-verify-callback) and [inbound_smtp_tls_verify_callback](/3/3-api/hooks.core.inbound_smtp_tls_verify_callback/hooks-core-inbound-smtp-tls-verify-callback) hooks.
