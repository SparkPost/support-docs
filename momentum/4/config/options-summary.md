---
title: "Chapter 66. Configuration Options Summary"
...
| [apn_expiry](/3/3-push/apns.apn_expiry/apns-apn-expiry) – Define the number of seconds after which an APNs notification is no longer valid | sending | yes (*non-dynamic*) | 4.0 and later | binding, binding_group, domain, global |
...
| [disable_chunked](/mobile/mobile-reference/mobility.mm7.listener/mobility-mm-7-listener) – Option used with aggregators who do not support chunked transfer-coding (Mobile Momentum) | both | false | 4.0 and later | http_listener, listen, pathway, pathway_group, peer |
...
| [gcm_application_id](/3/3-push/push.gcm.gcm_application_id/push-gcm-gcm-application-id) – Define the package name of the Android application allowed to received notifications | sending |   | 4.0 and later | binding, binding_group, domain, global |
| [gcm_authorization_token_id](/3/3-push/push.gcm.gcm_authorization_token_id/push-gcm-gcm-authorization-token-id) – Authorization token that permits sending Google push notifications | sending |   | 4.0 and later | binding, binding_group, domain, global |
| [gcm_delay_while_idle](/3/3-push/push.gcm.gcm_delay_while_idle/push-gcm-gcm-delay-while-idle) – Whether or not to send the notification immediately if a device is idle | sending | false | 4.0 and later | binding, binding_group, domain, global |
| [gcm_dry_run](/3/3-push/push.gcm.gcm_dry_run/push-gcm-gcm-dry-run) – Test a request without actually sending a message | sending | false | 4.0 and later | binding, binding_group, domain, global |
| [gcm_ttl](/3/3-push/push.gcm.gcm_ttl/push-gcm-gcm-ttl) – Default Time To Live for notifications | sending | -1 | 4.0 and later | binding, binding_group, domain, global |
...
| [http_listener](/3/3-rest/rest.http_listener/rest-http-listener) *(scope)* – Listener used with the REST injector | sending |   | 4.0 and later | global |
...
| [log_requests_to_paniclog](/3/3-rest/rest.http_listener/rest-http-listener) – Whether to log REST injection requests | sending | false | 4.0 and later | http_listener, listen, pathway, pathway_group, peer |
...
| [mcmt_reception](/mobile/mobile-reference/mm7.mcmt_reception/mm-7-mcmt-reception) – Configure a listener to accept the Multi-Channel Message Type (Mobile Momentum) | both | passthru | 4.0 and later | esmtp_listener, listen, pathway, pathway_group, peer |
...
| [xmpp_dialback_secret](/mobile/mobile-reference/mobility.xmpp.modules#mobility.xmpp.modules.xmpp_role.php/mobility-xmpp-modules#mobility.xmpp.modules.xmpp_role.php) – Use when verifying the XMPP server dialback key (Mobile Momentum) | both |   | 4.0 and later | domain |
| [xmpp_listener](/mobile/mobile-reference/mobility.xmpp.modules#modules.xmpp.xmpp_listener.php/mobility-xmpp-modules#modules.xmpp.xmpp_listener.php) *(scope)* – The listener for incoming XMPP connections (Mobile Momentum) | receiving |   | 4.0 and later | global |
| [xmpp_role](/mobile/mobile-reference/mobility.xmpp.modules#mobility.xmpp.modules.xmpp_role.php/mobility-xmpp-modules#mobility.xmpp.modules.xmpp_role.php) – Define whether a domain is an XMPP server or client (Mobile Momentum) | both |   | 4.0 and later | domain |