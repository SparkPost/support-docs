...
[idle_timeout](conf.ref.idle_timeout "idle_timeout"), [delivery_method](conf.ref.delivery_method "delivery_method"), and [Momentum for Mobile Push Notifications](/3/3-push/)