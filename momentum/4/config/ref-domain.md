...
For domain naming when using Momentum Mobile, see [Multi-protocol Domain Naming](/mobile/mobile-reference/mobility.mm7.multiprotocol/mobility-mm-7-multiprotocol).
