---
title: "Chapter 53. Using Complex Templates"
...
A general knowledge of command line tools, JSON, HTTP protocol, and templating languages is required. As a prerequisite, you should also be familiar with the information provided in the Substitutions Reference section of the [Momentum 4 REST API](/web-rest/v1_index.html/v-1-index-html) documentation.
...
Congratulations! You have used your knowledge of the REST API to create and use a complex template. For additional information, see [Momentum REST API](/web-rest/v1_index.html/v-1-index-html).