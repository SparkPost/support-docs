---
title: "Chapter 28. Data Replication"
...
[navigation path="/4/cluster.config.replication"]
...
## <a name="cluster.replication.features"></a> 28.1. Replication Configurations
...
### <a name="idp3700896"></a> 28.1.1. Tracking inbound connections via inbound_cidr
...
### <a name="idp3767360"></a> 28.1.2. Tracking outbound connections via outbound_cidr
...
### <a name="idp3770304"></a> 28.1.3. Tracking outbound connections via outbound_domain
...
### <a name="cluster.replication.inbound_audit"></a> 28.1.4. Replicated inbound audit metrics
...
### <a name="cluster.replicated_audit_series"></a> 28.1.5. Replicated named audit series
...
### <a name="cluster.replicatedcache"></a> 28.1.6. Replicated Caches
...
### <a name="cluster.replication.named_throttles"></a> 28.1.7. Shared named throttles
...
### <a name="cluster.replication.outbound_throttles"></a> 28.1.8. Shared Outbound Throttles
...
### <a name="cluster.replication.gauge_cache"></a> 28.1.9. Shared Gauge Caches
