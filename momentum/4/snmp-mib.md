...
## <a name="snmp-mib"></a> MIB Files

[navigation path="/4/snmp-mib"]
...
## <a name="snmp-mib-per-domain-metrics"></a> B.1. 1.3.6.1.4.1.19552.1.2 – Per-domain Metrics
...
### <a name="snmp-mib-MTAGroupIndexID"></a> B.1.1. Determining the ID for an MTAGroupIndexID
