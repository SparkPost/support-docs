...
When you are finished with the returned object, you must call [ec_blobject_delref](/3/3-api/apis.ec_blobject_delref/apis-ec-blobject-delref) to dispose of it.
...
This function returns a [ec_blobject](/3/3-api/structs.ec_blobject/structs-ec-blobject) or `NULL`.
