---
title: "Chapter 31. Configuring the Environment File"
...
*   `HTTPS_PROXY_PASSWORD` – for use with Adaptive Delivery (see [Using a Proxy Server](/3/3-ad/ad.adaptive.automated.proxy/ad-adaptive-automated-proxy).)

*   `HTTPS_PROXY_USERNAME` – for use with Adaptive Delivery (see [Using a Proxy Server](/3/3-ad/ad.adaptive.automated.proxy/ad-adaptive-automated-proxy).)
