---
title: "Chapter 27. DuraVIP™: IP Fail over"
...
[navigation path="/4/cluster.config.duravip"]
...
## <a name="cluster.config.duravip_follow"></a> 27.1. IP Addresses and `duravip_follow`
