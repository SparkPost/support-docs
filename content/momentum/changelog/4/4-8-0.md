...
title: "Momentum 4.8.0 Changelog"
description: "Momentum 4.8.0 was released on 2024-09-30. This section will list all of the major changes that happened with the release of Momentum 4.8.0. Depending on installation type, all changes may not be applicable"
---

This section will list all of the major changes that happened with the release of **Momentum 4.8.0**. Depending on installation type, all changes may not be applicable

<a name="changelog.4.8.0.table"></a>
