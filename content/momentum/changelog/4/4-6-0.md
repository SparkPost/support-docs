...
title: "Momentum 4.6.0 Changelog"
description: "Momentum 4.6.0 was released on 2023-10-26. This section will list all of the major changes that happened with the release of Momentum 4.6.0. Depending on installation type, all changes may not be applicable"
---

This section will list all of the major changes that happened with the release of **Momentum 4.6.0**. Depending on installation type, all changes may not be applicable
