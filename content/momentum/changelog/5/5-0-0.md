...
title: "Momentum 5.0.0 Changelog"
description: "Momentum 5.0.0 was released on 2025-03-01. This section will list all of the major changes that happened with the release of Momentum 5.0.0. Depending on installation type, all changes may not be applicable"
---

This section will list all of the major changes that happened with the release of **Momentum 5.0.0**. Depending on installation type, all changes may not be applicable

<a name="changelog.5.0.0.table"></a>
