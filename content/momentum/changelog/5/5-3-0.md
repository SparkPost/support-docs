...
The [`tls rekey`](/momentum/4/console-commands/tls) console command has been removed; it now responds with "tls command not understood", and the `tls show cache` output no longer includes a "Temp RSA key" line.
