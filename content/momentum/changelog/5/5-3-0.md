...
| Enhancement | I-1276 | The supported range of OpenSSL covers 1.1.1 (RHEL 8) through the 3.5.x series — all pre-1.1.1 compatibility code has been retired. A few obsolete TLS settings were removed as part of this change; see the [note](/momentum/4/changelog/5/5-3-0#changelog.5.3.0.openssl-removals) below. |
...
*   [`tls rekey`](/momentum/4/console-commands/tls) — console command (the `tls show cache` output no longer includes a "Temp RSA key" line)
