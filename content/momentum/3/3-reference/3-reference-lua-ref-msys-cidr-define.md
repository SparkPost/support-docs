...
description: "msys cidr define Define a named CIDR object msys cidr define name options Defines a named CIDR object A CIDR object is used to efficiently track information keyed by network address This function is intended to be used from a module init function Example 15 52 msys cidr define example..."
---
...
*   `type` can be `datasource`, `rbldnsd` or `empty`. For a detailed discussion see [the section called “CIDR Types”](/momentum/3/3-reference/3-reference-lua-ref-msys-cidr-define#lua.ref.msys.cidr.define.type).
...
### <a name="idp26279728"></a> datasource
...
### <a name="idp26304240"></a> empty

This value creates an empty CIDR that you can populate for yourself.

<a name="idp26305408"></a> 
## See Also

[“cidrdb – CIDRDB”](/momentum/3/3-reference/3-reference-modules-cidrdb), [msys.cidr.reload](/momentum/3/3-reference/3-reference-lua-ref-msys-cidr-reload), [msys.cidr.query](/momentum/3/3-reference/3-reference-lua-ref-msys-cidr-query)