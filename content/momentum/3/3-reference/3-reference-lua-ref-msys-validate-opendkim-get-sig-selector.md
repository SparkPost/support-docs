...
<a name="idp27665888"></a> 
## Synopsis

`msys.validate.opendkim.get_sig_selector(dkim_sig)`

`dkim_sig: userdata, DKIM_SIGINFO type`<a name="idp27668992"></a> 
## Description
