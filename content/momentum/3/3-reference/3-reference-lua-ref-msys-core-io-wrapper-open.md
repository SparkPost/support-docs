...
The code shown in [“msys.core.io_wrapper_open”](/momentum/3/3-reference/3-reference-lua-ref-msys-core-io-wrapper-open#lua.ref.msys.core.io_wrapper_open.example) assumes that a separate threadpool has been configured in `ecelerity.conf` in the following way:
...
For more information about threadpools see [threadpool](/momentum/3/3-reference/3-reference-conf-ref-threadpool).
...
<a name="idp24404288"></a> 
## See Also

[msys.runInPool](/momentum/3/3-reference/3-reference-lua-ref-msys-runinpool)