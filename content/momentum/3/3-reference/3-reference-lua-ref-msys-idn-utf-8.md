...
description: "msys idn to utf 8 Converts an IDN formatted string to unicode msys idn to utf 8 name Configuration Change This feature is available as beta in Momentum 3 6 12 to utf 8 attempts to convert an IDN formatted string to unicode If it is successful it returns the..."
---
...
<a name="idp24506464"></a> 
## Synopsis

`msys.idn.to_utf8(name);`

`name: string`<a name="idp24508752"></a> 
## Description
...
<a name="idp24515440"></a> 
## See Also

[msys.idn.to_idn](/momentum/3/3-reference/3-reference-lua-ref-msys-idn)