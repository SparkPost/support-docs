...
<a name="idp27397040"></a> 
## Synopsis

`msys.validate.opendkim.get_sig_domain(dkim_sig)`

`dkim_sig: userdata, DKIM_SIGINFO type`<a name="idp27400144"></a> 
## Description
