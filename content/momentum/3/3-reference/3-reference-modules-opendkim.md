...
### <a name="modules.opendkim.validate"></a> Validating
...
*   [msys.validate.opendkim.get_sig_identity](/momentum/3/3-reference/3-reference-lua-ref-msys-validate-opendkim-get-sig-identity)
