...
[Table 14.5, “TLS Logging Macros”](/momentum/3/3-reference/3-reference-tls-macros#tls-macros-table) lists the TLS logging macros.
...
For more information on the custom_logger, see [“custom_logger – Customizable Logging”](/momentum/3/3-reference/3-reference-modules-custom-logger).