...
### <a name="idp17805520"></a> Configuration Options
...
A dictionary that maps a column to an encryption type. See [The `type_map` Option](/momentum/3/3-reference/3-reference-modules-auth-ds#modules.auth_ds.type_map) for complete information.
...
### <a name="idp17850784"></a> Parameter expansion maps
...
For licensing reasons the MySQL module does not ship with Momentum and must be downloaded separately. For instructions on downloading and installing this module see [“MySQL”](/momentum/3/3-reference/3-reference-modules-ds-core#modules.ds_core.ds_mysql).
