...
### <a name="idp11779952"></a> SNMP Agent setup
...
Momentum trap definitions are contained in the MIB file `OMNITI-SNMP-MIB.txt` found in the `/opt/msys/ecelerity/docs/` directory. For your convenience this file is reproduced in [*MIB Files*](/momentum/3/3-reference/3-reference-snmp-mib) .
