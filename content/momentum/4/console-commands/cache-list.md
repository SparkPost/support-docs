...
The **cache list**      command is useful for determining the cache names to use with the [cache stat](/momentum/4/console-commands/cache-stat) command.
...
[cache stat](/momentum/4/console-commands/cache-stat), [cache stats](/momentum/4/console-commands/cache-stats), [match_cache_life](/momentum/4/config/ref-match-cache-life)