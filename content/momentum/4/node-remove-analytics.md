...
### <a name="node_remove_analytics.update_platform_config_files"></a> Update Configuration Files on all Platform/MTA/Log Aggregator Nodes
...
### <a name="node_remove_analytics.update_application_config_files"></a> Update Configuration Files on Remaining Application Nodes
...
### <a name="node_remove_analytics.vertica"></a> Remove the Node from the Vertica Cluster
