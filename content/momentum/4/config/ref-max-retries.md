...
<a name="idp25347328"></a> 
## Scope

`max_retries` is valid in the binding, binding_group, domain and global scopes.

<a name="idp25349632"></a> 
## See Also

[message_expiration](/momentum/4/config/ref-message-expiration) and [max_retry_interval](/momentum/4/config/ref-max-retry-interval)