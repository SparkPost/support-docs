...
You may also wish to add the chunk_logger log file to `ec_rotate.conf`, to ensure that it is rotated daily. For more information, see [“chunk_logger Module”](/momentum/4/modules/chunk-logger) and [ec_rotate](/momentum/4/executable/ec-rotate).
