...
**Note**: to send with SparkPost, Magento needs to use *From* addresses with a *verified sending domain* from your SparkPost account. Learn about configuring [SparkPost sending domains](https://docs.sparkpost.com/docs/user-guide/managing-sending-domains/).
...
* Password: `<your SparkPost API key>`
    * [How to create a SparkPost API key](https://docs.sparkpost.com/docs/getting-started/create-api-keys/)
