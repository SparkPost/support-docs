...
Choose the method that works best for you. View [this support article](https://docs.sparkpost.com/docs/getting-started/getting-started-sparkpost/#preparing-your-from-address) for more detailed information on setting up sending domains.
