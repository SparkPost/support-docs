...
**This article assumes you are familiar with Elixir and the `mix` and `iex` CLIs. We also assume that you have [created an API key](/docs/getting-started/create-api-keys/) with the "Send via SMTP" permission.**
