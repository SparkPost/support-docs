...
1. A verified [configured Sending Domain for use with SparkPost](/docs/getting-started/getting-started-sparkpost/#preparing-your-from-address)
1. Your SparkPost account password
1. A [valid SparkPost API Key](/docs/getting-started/create-api-keys/)
