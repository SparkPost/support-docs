...
If you need more options, check out cross-platform tools such as [swaks ("Swiss Army Knife for SMTP")](https://docs.sparkpost.com/docs/tech-resources/smtp-injection-with-starttls-using-swaks/).
