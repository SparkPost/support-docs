...
This page defines Metrics for Enterprise accounts. For other accounts see [Metric Definitions](https://docs.sparkpost.com/docs/reporting/metrics-definitions/).
