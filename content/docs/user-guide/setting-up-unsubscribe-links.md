...
[Create a webhook](https://developers.sparkpost.com/api/webhooks/) or update an existing webhook to include the **List Unsubscribe** (and/or) the **Link Unsubscribe** event types in the Message Category.
