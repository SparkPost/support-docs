...
### Subaccount Requests
If applicable, select if this request applies to the primary account, the primary and all subaccounts, or one specific subaccount. Learn more about subaccounts [here](https://docs.sparkpost.com/docs/user-guide/subaccounts/).
