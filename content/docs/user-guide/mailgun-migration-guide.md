...
As well as the usual HTML content, [SparkPost templates](https://docs.sparkpost.com/docs/getting-started/creating-template/) can have optional plain-text and [AMP HTML](https://docs.sparkpost.com/docs/user-guide/amp-for-email/) parts. The substitution variables work on these parts too.
...
SparkPost also supports [A/B testing](https://docs.sparkpost.com/docs/tech-resources/a-b-testing-sparkpost/), a common method of comparing templates to see which one performs better. SparkPost provides the means to create automated A/B tests and view completed results.
...
Your Mailgun account alerts you by email when approaching your account sending limit. In SparkPost, you can [set up alerts](https://docs.sparkpost.com/docs/user-guide/alerts/) to track the following metrics:
...
-   [Health Score](https://docs.sparkpost.com/docs/reporting/health-score/)
-   [Spam Trap Monitoring](https://docs.sparkpost.com/docs/reporting/spam-trap-monitoring/)
-   [Engagement Recency](https://docs.sparkpost.com/docs/reporting/engagement-recency/)
...
If you have an issue with your SparkPost account, you can [check out our support articles here](https://docs.sparkpost.com/docs/) and [contact our Support team directly from your app dashboard](https://app.sparkpost.com/dashboard).
